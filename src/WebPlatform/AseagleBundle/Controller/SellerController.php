...
class SellerController extends Controller
{
    public function newAction(Request $request)
    {
        ...
        $form = $this->createFormBuilder($company_profile)
            ...
            ->add('annual_revenue', 'integer', array('label' => 'Annual Revenue:', 'attr'=> array('class'=>'form-control input-md')) )
            ...
            ->add('main_markets_distribution', 'text', array('label' => 'Key Export Markets:', 'attr'=> array('class'=>'form-control input-md')))
            ->add('main_products', 'text', array('label' => 'Primary Productions:', 'attr'=> array('class'=>'form-control input-md')))
            ->add('global_offices', 'text', array('label' => 'Global Offices:', 'attr'=> array('class'=>'form-control input-md')))
